...
Proof.
  ...
  - simpl in H1. inversion H1. apply IHev in H0. apply H0.
Qed.
(** [] *)
...
Inductive always_nat : nat -> nat -> Prop :=
  | al n m : always_nat n m.
...
Inductive never_nat : nat -> nat -> Prop :=
  | nv (H: False) : never_nat 0 0.
...
Proof.
  intros m n o H1 H2. induction H2 as [|o' H' IH'].
  - apply H1.
  - apply le_S. apply IH'.
Qed. 
...
Proof.
  ...
  - reflexivity.
  - apply (le_trans n (S n) m (le_S n n (le_n n)) H1).
Qed.
...
Proof.
  ...
  - intros m H. destruct m.
    ...
    + apply n_le_m__Sn_le_Sm. simpl in H. apply (IHn' _ H).
Qed.
...
Inductive subseq : list nat -> list nat -> Prop :=
  | ss_nil l : subseq [] l
  | ss_cons l1 l2 x (H: subseq l1 l2) : subseq (x :: l1) (x :: l2)
  | ss_cons2 l1 l2 x (H: subseq l1 l2) : subseq l1 (x :: l2)
.
...
Proof.
  ...
  - apply ss_nil.
  - simpl. apply (ss_cons l1 (l2 ++ l3) x IHsubseq).
  - simpl. apply (ss_cons2 l1 (l2 ++ l3) x IHsubseq).
Qed.
...
Theorem subseq_trans : forall (l1 l2 l3 : list nat),
  ...
  subseq l1 l3.
Proof.
  intros l1 l2 l3 H1 H2. generalize dependent l1. induction H2 as [|l2' l3' x H'|l2' l3' x H'].
  - intros l1 H1. inversion H1. apply ss_nil.
  - intros l1 H1. inversion H1.
    + apply ss_nil.
    + apply ss_cons. apply IHH'. apply H2.
    + apply ss_cons2. apply (IHH' _ H2).
  - intros l1 H1. apply ss_cons2. apply (IHH' _ H1).
Qed.
(** [] *)
...
Lemma empty_is_empty : forall T (s : list T),
  ~ (s =~ EmptySet).
Proof.
  intros T s Hc. inversion Hc. Qed.
...
Proof.
  ...
  - (* l = [] *)
    simpl. intros H. unfold "<>" in H. apply H. reflexivity.
  - (* l = m :: l' *)
...
Proof.
  ...
  - destruct b.
    + reflexivity.
    + inversion H. intro H1. contradiction.
  - inversion H.
    + intros H2. apply H0.
