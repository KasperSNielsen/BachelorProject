...
Example injection_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  x = y.
Proof.
  intros X x y z l j eq1 eq2. injection eq1. rewrite eq2. intros H1 H2.
  injection H1. intros H3. transitivity z. apply H2. symmetry. apply H3.
Qed.
(** [] *)
...
Proof.
  ...
  - intros m eq1. destruct m as [|m'].
    + reflexivity.
    + discriminate.
  - intros m eq2. destruct m as [|m'].
    + discriminate.
    + f_equal. apply IHn'. simpl in eq2. apply eq2.
Qed.
(** [] *)
...
Proof.
  ...
  - intros m H2. destruct m as [|m'].
    + discriminate H2.
    + f_equal. apply IHn'. rewrite <- plus_n_Sm in H2. rewrite <- plus_n_Sm in H2. 
      injection H2 as H3. apply H3.
Qed.  
(** [] *)
...
Proof.
  ...
  induction l as [|x l'].
  - reflexivity.
  - intros n eq. simpl in eq. destruct n as [|n'].
    + simpl. discriminate.
    + simpl. apply IHl'. injection eq as goal. apply goal.
Qed.
(** [] *)
...
Proof.
  ...
  - intros l1 l2 H. simpl in H. injection H as H1 H2. rewrite <- H1. rewrite <- H2. simpl. reflexivity.
  - intros l1 l2 H. destruct a as [x y]. simpl in H. destruct (split l') as [l1' l2'] eqn:E. injection H as H1 H2. 
    rewrite <- H1. rewrite <- H2. simpl. f_equal. apply IHl'. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros n. induction n as [|n'].
  - intros m. destruct m as [|m'] eqn:E2.
    + reflexivity.
    + reflexivity.
  - intros m. destruct m as [|m'] eqn:E2.
    + reflexivity.
...
Theorem eqb_trans : forall n m p,
  ...
  n =? p = true.
Proof.
  intros n m p H1 H2. apply eqb_true in H1. apply eqb_true in H2. rewrite -> H1. rewrite <- H2.
...
Definition split_combine_statement : Prop
  ...
  := forall X Y (l : list (X * Y)) l1 l2,
     length l1 = length l2 -> l = combine l1 l2 -> split l = (l1, l2).
