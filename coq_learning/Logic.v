...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  intros P H1 Q H2. contradiction.
Qed.
(** [] *)
...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q H H1. unfold not in H1. unfold not. intros H2.
  apply H in H2. apply H1 in H2. destruct H2.
Qed.
(** [] *)
...
Theorem not_both_true_and_false : forall P : Prop,
  ~ (P /\ ~P).
Proof.
  intros P. unfold not. intros H. destruct H as [H1 H2]. apply H2 in H1. destruct H1.
Qed. 
(** [] *)
...
Proof.
  intros X P H H1. destruct H1 as [x E]. unfold not in E.
...
Proof.
  intros X P Q. split.
  - intros H. destruct H as [x' E]. destruct E.
...
Proof.
  intros Podd Peven n H1 H2. unfold combine_odd_even. destruct (oddb n) eqn:E.
